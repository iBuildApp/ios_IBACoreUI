...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IBACoreUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9IBACoreUI15AlertController")
...
SWIFT_CLASS("_TtC9IBACoreUI18StubViewController")
...
SWIFT_CLASS("_TtC9IBACoreUI22AlertWrapperController")
@interface AlertWrapperController : StubViewController
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9IBACoreUI8Checkbox")
...
SWIFT_CLASS("_TtC9IBACoreUI16CommantReplyView")
@interface CommantReplyView : UIView
...
SWIFT_CLASS("_TtC9IBACoreUI11CommentView")
...
SWIFT_CLASS("_TtC9IBACoreUI11DTTextField")
...
SWIFT_CLASS("_TtC9IBACoreUI10DTTextView")
...
SWIFT_CLASS("_TtC9IBACoreUI14EdgeInsetLabel")
...
SWIFT_CLASS("_TtC9IBACoreUI15GrowingTextView")
...
SWIFT_CLASS("_TtC9IBACoreUI20NavigationController")
...
SWIFT_CLASS("_TtC9IBACoreUI16PaddingTextField")
...
SWIFT_CLASS("_TtC9IBACoreUI23PreloaderViewController")
@interface PreloaderViewController : BaseViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9IBACoreUI10RadioGroup")
...
SWIFT_CLASS("_TtC9IBACoreUI20TabBarViewController")
...
@interface TabBarViewController (SWIFT_EXTENSION(IBACoreUI)) <UITabBarControllerDelegate>
...
@interface TabBarViewController (SWIFT_EXTENSION(IBACoreUI)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC9IBACoreUI13TextInputView")
...
@interface UIView (SWIFT_EXTENSION(IBACoreUI))
